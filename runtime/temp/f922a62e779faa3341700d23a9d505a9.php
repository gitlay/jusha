<?php /*a:3:{s:60:"/www/wwwroot/jusha/application/admin/view/system/system.html";i:1545543491;s:58:"/www/wwwroot/jusha/application/admin/view/common/head.html";i:1545543491;s:58:"/www/wwwroot/jusha/application/admin/view/common/foot.html";i:1545543491;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-tab-item layui-show">
                <form class="layui-form layui-form-pane" lay-filter="form-system">
                    ...
                    <div class="layui-form-item">
                        ...
                        <input type="hidden" name="qrcodec" id="logoc">
                        <div class="layui-input-block">
                            <div class="layui-upload">
                                <button type="button" class="layui-btn layui-btn-primary" id="logoBtnc"><i class="icon icon-upload3"></i>点击上传</button>
                                <div class="layui-upload-list">
                                    <img class="layui-upload-img" id="cltLogoc">
                                    <p id="demoTextc"></p>
                                </div>
                            </div>
                        </div>
...
<script>
    layui.use(['form', 'layer','upload','element'], function () {
        ...
        $('#cltLogoc').attr('src',seytem.qrcodec);
        //普通图片上传
        ...
        var uploadInstc = upload.render({
            ...
            ,before: function(obj){
                //预读本地文件示例，不支持ie8
                obj.preview(function(index, file, result){
                    $('#cltLogoc').attr('src', result); //图片链接（base64）
                });
            }
            ,done: function(res){
                //上传成功
            ...
            ,error: function(){
                //演示失败状态，并实现重传
                var demoTextc = $('#demoTextc');
                demoTextc.html('<span style="color: #FF5722;">上传失败</span> <a class="layui-btn layui-btn-mini demo-reload">重试</a>');
                demoTextc.find('.demo-reload').on('click', function(){
                    uploadInstc.upload();
                });
            }
        });
