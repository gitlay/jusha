<?php /*a:3:{s:61:"E:\phpStudy\WWW\jusha\application\admin\view\module\form.html";i:1545055853;s:61:"E:\phpStudy\WWW\jusha\application\admin\view\common\head.html";i:1545055853;s:61:"E:\phpStudy\WWW\jusha\application\admin\view\common\foot.html";i:1545055853;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main layui-anim layui-anim-upbit" ng-app="hd" ng-controller="ctrl">
    ...
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="name" <?php if((ACTION_NAME == 'edit')): ?>disabled<?php endif; ?> ng-model="field.name" placeholder="必填：模型表名" lay-verify="required" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
