			...
			<div class="info ">
				...
				<div class="brand ">
					...
					<ul class="brand-nav" v-show="navShow">
						...
						<li><a href="yqp_index.html">首页</a></li>
						<li><a href="about.html">公司介绍</a></li>
						<li><a href="dynamic.html">行业动态</a></li>
						<li><a href="index.html">车型展示</a></li>
				...
				fixShow:function(i){
					...
					if(i==0){
					  ...
					  this.yunyingShow = false
                        ...
                        console.log(this.cars[this.currentIndex])
...
//		      	that.currentIndex = (swiper.activeIndex -3 ) % 6
		...
		<div class="bottom">
			...
			<div class="copyright">
				<div class="text"> <span class="time">@2005-2011</span> ,www.xxxxx.com巨鲨汽车网站版权所有 沪ICP备XXXXX号</div>
			</div>
		</div>
	</body>
</html>
