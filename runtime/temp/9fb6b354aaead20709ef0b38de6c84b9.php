<?php /*a:3:{s:62:"E:\phpStudy\WWW\jusha\application\admin\view\module\field.html";i:1545055853;s:61:"E:\phpStudy\WWW\jusha\application\admin\view\common\head.html";i:1545055853;s:61:"E:\phpStudy\WWW\jusha\application\admin\view\common\foot.html";i:1545055853;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    layui.use('table', function() {
        ...
        var tableIn=table.render({
            ...
            cols: [[
                ...
                {field: 'sort', title: '<?php echo lang("order"); ?>', width: 100, sort: true,templet: '#order'},
        ...
        $('body').on('blur','.list_order',function() {
            ...
            $.post('<?php echo url("listOrder"); ?>',{id:id,sort:sort,moduleid:"<?php echo input('id'); ?>"},function(res){
                layer.close(loading);
                if(res.code===1){
                    layer.msg(res.msg,{time:1000,icon:1});
                    tableIn.reload();
