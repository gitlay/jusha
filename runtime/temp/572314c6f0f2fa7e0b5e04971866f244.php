<?php /*a:3:{s:66:"E:\phpStudy\WWW\jusha\application\admin\view\module\fieldForm.html";i:1545055853;s:61:"E:\phpStudy\WWW\jusha\application\admin\view\common\head.html";i:1545055853;s:61:"E:\phpStudy\WWW\jusha\application\admin\view\common\foot.html";i:1545055853;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    m.controller('ctrl',['$scope',function($scope) {
        ...
        layui.use(['form', 'layer'], function () {
            ...
            form.on('submit(submit)', function (data) {
                ...
                data.field.moduleid = "<?php echo htmlentities($moduleid); ?>";
                if($scope.field.id){
    ...
    function field_setting(info,action,form) {
        if(action=='add'){
            var data =  '';
            var url =  "<?php echo url('fieldAdd'); ?>?isajax=1&moduleid=<?php echo htmlentities($moduleid); ?>&type="+type.value;
        }else{
            var data = info.setup;
            var url =  "<?php echo url('fieldAdd'); ?>?isajax=1&moduleid=<?php echo htmlentities($moduleid); ?>&type="+info.type+"&name="+info.field;
        }
        $.ajax({
            type: "POST",
            url: url,
